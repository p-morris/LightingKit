...
class TestModelEquatable: XCTestCase {
    func testHomeEquals() {
        ...
        let home1 = Home(name: "Test", uuid: uuid)
    ...
    func testRoomEqual() {
        let uuid = UUID(uuidString: "E621E1F8-C36C-495A-93FC-0C247A3E6E5F")!
        let room1 = Room(name: "Test", uuid: uuid)
    ...
    func testLightEqual() {
        let uuid = UUID(uuidString: "E621E1F8-C36C-495A-93FC-0C247A3E6E5F")!
        let light1 = Light(name: "Test", uuid: uuid)
        let light2 = Light(name: "Test2", uuid: uuid)
    ...
    func testLightNotEqual() {
        ...
        let uuid2 = UUID(uuidString: "E621E1F8-C36C-495A-93FC-0C247A3E6E5E")!
        let light1 = Light(name: "Test", uuid: uuid)
        let light2 = Light(name: "Test2", uuid: uuid2)
    ...
    func testLightEqualToHomeKitObject() {
        let uuid = UUID(uuidString: "E621E1F8-C36C-495A-93FC-0C247A3E6E5F")!
        let light = Light(name: "Test", uuid: uuid)
